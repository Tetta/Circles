...
namespace UnityEngine.Purchasing
{
    ...
    public class CodelessIAPStoreListener : IStoreListener
    {
        ...
        public static event Action<IStoreController, IExtensionProvider> onInitializedComplete = delegate { };
        ...
        public void OnInitialized(IStoreController controller, IExtensionProvider extensions)
        {
            ...
            onInitializedComplete(controller, extensions);
        }
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs e)
        {
            ...
            for (int i = 0; i < activeButtons.Count; i++) {
                if (i >= activeButtons.Count) break;
